...
import usecase from "../../assets/img/speed_8252022_layout_06.jpg";
...
import usecase5 from "../../assets/img/2306.i504.005.S.m005.c13.isometric traffic road barriers isolated.jpg"
                ...
                <>
                  {case_left ? (
                    ...
                    // style={{ background: "#ffe06f" }}
                      style={{background:"pink", marginLeft:"10px" }}
                      key={id}
